...
export const PrescriptionList: React.FC<PrescriptionListProps> = ({ prescriptions, onAnalyse, isAnalysisDisabled }) => {
  return (
    <div>
      <h2 className="text-2xl font-bold text-primary mb-6">Your Prescriptions</h2>
